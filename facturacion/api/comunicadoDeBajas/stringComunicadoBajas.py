...
def stringAnulacionF(data : dict, fileName : str) -> str:
    try:
        ...
        <cbc:ReferenceDate>{documentos[0]["fecha"]}</cbc:ReferenceDate>
    ...
    '''  
        ...
        for documento in documentos:
            ...
            <sac:VoidedDocumentsLine>
                ...
                <cbc:DocumentTypeCode>{documento["tipoDocumento"]}</cbc:DocumentTypeCode>
                <sac:DocumentSerialID>{documento["serie"]}</sac:DocumentSerialID>
                <sac:DocumentNumberID>{documento["numero"]}</sac:DocumentNumberID>
                <sac:VoidReasonDescription><![CDATA[{documento["motivo"]}]]></sac:VoidReasonDescription>
            </sac:VoidedDocumentsLine>
        ''' 
